  ...
  - [2.1. Pattern Property `^([a-z0-9_-]+)+$`](#languages_pattern1)
    - [2.1.1. tool-definition](#autogenerated_heading_4)
      ...
      - [2.1.1.26. Property `symbol-formats`](#languages_pattern1_items_symbol-formats)
        - [2.1.1.26.1. symbol-formats items](#autogenerated_heading_7)
      - [2.1.1.27. Property `root-markers`](#languages_pattern1_items_root-markers)
        - [2.1.1.27.1. root-markers items](#autogenerated_heading_8)
...
##### <a name="autogenerated_heading_7"></a>2.1.1.26.1. symbol-formats items
...
##### <a name="autogenerated_heading_8"></a>2.1.1.27.1. root-markers items
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-12-23 at 18:32:59 -0800
